...
# calculation of stress factors 
  ...
  # add stressful factors
    m = 7
    weighted = 0 # weights obtained from the frequency of occurrence of each stress factor observed in Table 3 and 7
      w1 = 0.15789 # 0.10159 
      w2 = 0.16667 # 0.13642
      w3 = 0.13157 # 0.05494
      w4 = 0.16667 # 0.20062
...
# results of Table 2
  ...
  Table2 = cbind(Games, ACB_position, round(opcionA, digits=2), round(opcionB, digits=2)) # Table 2
  Table2
...
### obtaining the results shown in Table 4
  ...
  Table4 = cbind(wins, mi, round(opcionA_mi, digits=2), round(opcionB_mi, digits=2)) # Table 4
  Table4
...
#################################################################################################################
### obtaining the results shown in Table 5
  ...
  cor(TRIs, method="spearman") # results shown in Table 5
...
#################################################################################################################
### obtaining the results shown in Table 6 
...
#################################################################################################################
### obtaining the results shown in Table XXXXX   
